<?php
	...
	if(empty($_SESSION['user_id']))  
	{
        ...
        <!-- ORDER MODAL -->
        <?php
            $get_all_orders = mysqli_query($db, "SELECT SUM(quantity) as quantity,SUM(price) as price, mop, s_fee, s_address, original_address, status, order_number FROM user_orders WHERE u_id='".$_SESSION['user_id']."' AND status != 'rejected' GROUP BY order_number , mop, s_fee,s_address, original_address, status");
            if(mysqli_num_rows($get_all_orders) > 0)
            {
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-1 d-flex align-items-center">
                                                                        <div class="d-flex align-items-center justify-content-center">
                                                                            ...
                                                                            ?>
                                                                            <div class="o__order-card-item-cancel mb-0 text-white" disabled><i class="fa-solid fa-square-xmark fs-5"></i></div>
                                                                            <?php
                                                                            }
                                                                            ?>
                                                                        </div>
                                                                    ...
                                                                    <div class="col-1 d-flex align-items-center">
                                                                        <div class="d-flex align-items-center justify-content-center">
                                                                            ...
                                                                            <form action="add_cart" method="POST">
                                                                                ...
                                                                                <input type="hidden" name="id" value="<?=$dish['o_id']?>">
                                                                                <button type="submit" id="cancel_order" data-date="<?=$dish['date']?>" data-id="<?=$dish['o_id']?>" data-num="<?=$row['order_number']?>" class="o__order-card-item-cancel mb-0 cancel_order d-inline-flex bg-white"><i class="fa-solid fa-square-xmark fs-5"></i></button>
                                                                                <!-- <a id="cancel_order" data-date="<?=$dish['date']?>" data-id="<?=$dish['o_id']?>" data-num="<?=$row['order_number']?>" class="o__order-card-item-cancel mb-0 cancel_order"><i class="fa-solid fa-square-xmark fs-5"></i></a> -->
                                                                            </form>
                                                                            <?php
                                                                            } else {
                                                                            ?>
                                                                            <div class="o__order-card-item-cancel mb-0 text-secondary" disabled><i class="fa-solid fa-square-xmark fs-5"></i></div>
                                                                            <?php
                                                                            }
                                                                            ?>
                                                                        </div>
...
<script>
	...
	jQuery(function($) {
		$(document).ready(function () {
            ...
            //                         // $('.order_modal-wrap').empty().html(response);
            //                     }
            //                 });
