...
<body class="fix-header">
    ...
    <div id="main-wrapper">
                    ...
                    <ul id="sidebarnav">
                        ...
                        <li> <a class="has-arrow  " href="#" aria-expanded="false"><i class="fa fa-cutlery" aria-hidden="true"></i><span class="hide-menu">Menu</span></a>
                            <ul aria-expanded="false" class="collapse">
								...
								<li><a href="add_food_category.php">Add Food Category</a></li>
                            </ul>
                        </li>
        ...
        <div class="page-wrapper">
                                ...
                                <form action='' method='post' >
                                    <div class="form-body">
                                        ...
                                        <div class="form-actions">
                                            ...
                                            <a href="add_food_category.php" class="btn btn-inverse">Cancel</a>
                                        </div>
                                    </div>
                                </form>
                            </div>
                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                                            <tr>
                                                                ...
                                                                <td><a href="delete_category.php?cat_del=<?=$rows['f_catid']?>" class="btn btn-danger btn-flat btn-addon btn-xs m-b-10"><i class="fa fa-trash-o" style="font-size:16px"></i></a> 
                                                                    <a href="update_category.php?cat_upd=<?=$rows['f_catid']?>" class="btn btn-info btn-flat btn-addon btn-sm m-b-10 m-l-5"><i class="fa fa-edit"></i></a>
                                                                </td>
                                                            </tr>
                                            <?php
                                                        }	
            ...
            <footer class="footer"> © <?= date('Y')?> - Online Food Ordering System </footer>
        </div>
