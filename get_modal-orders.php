    ...
    <div class="modal-dialog modal-dialog-centered">
        ...
        <div class="modal-body" id="">
            ...
            <?php
                ...
                $get_single = mysqli_query($db,'SELECT user_orders.*, (SELECT SUM(price*quantity) FROM user_orders WHERE status != "rejected" AND order_number="'.$row['order_number'].'") as total_price FROM user_orders WHERE u_id="'.$_SESSION["user_id"].'" AND order_number="'.$row['order_number'].'"');
